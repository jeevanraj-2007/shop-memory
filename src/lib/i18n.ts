...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Custom fields
    'cf.measurements': 'Measurements',
    'cf.fabricType': 'Fabric Type',
    'cf.designNotes': 'Design Notes',
    'cf.grainType': 'Grain Type',
    'cf.quantity': 'Quantity',
    'cf.millingType': 'Milling Type',
    'cf.clayType': 'Clay Type',
    'cf.size': 'Size',
    'cf.brand': 'Brand',
    'cf.deviceType': 'Device Type',
    'cf.problemDesc': 'Problem Description',
    'cf.serialNumber': 'Serial Number',
    'cf.classGrade': 'Class / Grade',
    'cf.batchTime': 'Batch Timing',
    'cf.parentName': "Parent's Name",
    'cf.deliveryAddress': 'Delivery Address',
    'cf.notes': 'Notes',

    // Checklist items
    'cl.cutFabric': 'Cut Fabric',
    'cl.stitch': 'Stitch',
    'cl.buttons': 'Buttons & Finishing',
    'cl.iron': 'Iron / Press',
    'cl.qualityCheck': 'Quality Check',
    'cl.grainReceived': 'Grain Received',
    'cl.cleaning': 'Cleaning',
    'cl.milling': 'Milling',
    'cl.packing': 'Packing',
    'cl.readyPickup': 'Ready for Pickup',
    'cl.shaping': 'Shaping',
    'cl.drying': 'Drying',
    'cl.firing': 'Firing',
    'cl.painting': 'Painting / Glazing',
    'cl.readyDelivery': 'Ready for Delivery',
    'cl.itemPicked': 'Item Picked',
    'cl.packed': 'Packed',
    'cl.delivered': 'Delivered',
    'cl.diagnosed': 'Diagnosed',
    'cl.partsOrdered': 'Parts Ordered',
    'cl.repairDone': 'Repair Done',
    'cl.testing': 'Testing',
    'cl.enrolled': 'Enrolled',
    'cl.booksGiven': 'Books Given',
    'cl.firstSession': 'First Session Done',
    'cl.feeCollected': 'Fee Collected',
    'cl.loaded': 'Loaded',
    'cl.dispatched': 'Dispatched',
  ...
  hi: {
    ...
    'cf.measurements': 'नाप',
    'cf.fabricType': 'कपड़े का प्रकार',
    'cf.designNotes': 'डिज़ाइन नोट्स',
    'cf.grainType': 'अनाज का प्रकार',
    'cf.quantity': 'मात्रा',
    'cf.millingType': 'मिलिंग प्रकार',
    'cf.clayType': 'मिट्टी का प्रकार',
    'cf.size': 'आकार',
    'cf.brand': 'ब्रांड',
    'cf.deviceType': 'उपकरण का प्रकार',
    'cf.problemDesc': 'समस्या विवरण',
    'cf.serialNumber': 'सीरियल नंबर',
    'cf.classGrade': 'कक्षा / ग्रेड',
    'cf.batchTime': 'बैच का समय',
    'cf.parentName': 'अभिभावक का नाम',
    'cf.deliveryAddress': 'डिलीवरी पता',
    'cf.notes': 'नोट्स',

    'cl.cutFabric': 'कपड़ा काटा',
    'cl.stitch': 'सिलाई',
    'cl.buttons': 'बटन और फिनिशिंग',
    'cl.iron': 'इस्त्री / प्रेस',
    'cl.qualityCheck': 'गुणवत्ता जांच',
    'cl.grainReceived': 'अनाज प्राप्त',
    'cl.cleaning': 'सफाई',
    'cl.milling': 'पिसाई',
    'cl.packing': 'पैकिंग',
    'cl.readyPickup': 'पिकअप के लिए तैयार',
    'cl.shaping': 'आकार देना',
    'cl.drying': 'सुखाना',
    'cl.firing': 'भट्ठी में पकाना',
    'cl.painting': 'रंगाई / ग्लेज़िंग',
    'cl.readyDelivery': 'डिलीवरी के लिए तैयार',
    'cl.itemPicked': 'सामान चुना',
    'cl.packed': 'पैक किया',
    'cl.delivered': 'डिलीवर किया',
    'cl.diagnosed': 'जांच हुई',
    'cl.partsOrdered': 'पार्ट्स मंगवाए',
    'cl.repairDone': 'मरम्मत हुई',
    'cl.testing': 'टेस्टिंग',
    'cl.enrolled': 'दाखिला हुआ',
    'cl.booksGiven': 'किताबें दी',
    'cl.firstSession': 'पहला सत्र हुआ',
    'cl.feeCollected': 'फीस ली',
    'cl.loaded': 'लोड किया',
    'cl.dispatched': 'भेजा',
    'cl.received': 'प्राप्त',
    'cl.inProgress': 'प्रगति में',
    'cl.completed': 'पूरा हुआ',

    reminders: 'रिमाइंडर',
    reminderDate: 'रिमाइंडर तारीख',
    noReminders: '🔔 कोई आगामी रिमाइंडर नहीं!',
    overdueReminders: 'देरी से',
  ...
  te: {
    ...
    'cf.measurements': 'కొలతలు',
    'cf.fabricType': 'వస్త్ర రకం',
    'cf.designNotes': 'డిజైన్ నోట్స్',
    'cf.grainType': 'ధాన్యం రకం',
    'cf.quantity': 'పరిమాణం',
    'cf.millingType': 'మిల్లింగ్ రకం',
    'cf.clayType': 'మట్టి రకం',
    'cf.size': 'పరిమాణం',
    'cf.brand': 'బ్రాండ్',
    'cf.deviceType': 'పరికర రకం',
    'cf.problemDesc': 'సమస్య వివరణ',
    'cf.serialNumber': 'సీరియల్ నంబర్',
    'cf.classGrade': 'తరగతి / గ్రేడ్',
    'cf.batchTime': 'బ్యాచ్ సమయం',
    'cf.parentName': 'తల్లిదండ్రుల పేరు',
    'cf.deliveryAddress': 'డెలివరీ చిరునామా',
    'cf.notes': 'నోట్స్',

    'cl.cutFabric': 'గుడ్డ కత్తిరించడం',
    'cl.stitch': 'కుట్టు',
    'cl.buttons': 'బటన్లు & ఫినిషింగ్',
    'cl.iron': 'ఇస్త్రీ',
    'cl.qualityCheck': 'నాణ్యత తనిఖీ',
    'cl.grainReceived': 'ధాన్యం అందుకున్నారు',
    'cl.cleaning': 'శుభ్రపరచడం',
    'cl.milling': 'మిల్లింగ్',
    'cl.packing': 'ప్యాకింగ్',
    'cl.readyPickup': 'పికప్‌కు సిద్ధం',
    'cl.shaping': 'ఆకారం ఇవ్వడం',
    'cl.drying': 'ఆరబెట్టడం',
    'cl.firing': 'కాల్చడం',
    'cl.painting': 'రంగు వేయడం',
    'cl.readyDelivery': 'డెలివరీకి సిద్ధం',
    'cl.itemPicked': 'వస్తువు తీసుకున్నారు',
    'cl.packed': 'ప్యాక్ చేసారు',
    'cl.delivered': 'డెలివరీ అయింది',
    'cl.diagnosed': 'పరీక్షించారు',
    'cl.partsOrdered': 'విడిభాగాలు ఆర్డర్ చేసారు',
    'cl.repairDone': 'మరమ్మత్తు పూర్తి',
    'cl.testing': 'టెస్టింగ్',
    'cl.enrolled': 'చేరిక',
    'cl.booksGiven': 'పుస్తకాలు ఇచ్చారు',
    'cl.firstSession': 'మొదటి సెషన్ పూర్తి',
    'cl.feeCollected': 'ఫీజు సేకరించారు',
    'cl.loaded': 'లోడ్ చేసారు',
    'cl.dispatched': 'పంపారు',
    'cl.received': 'అందుకున్నారు',
    'cl.inProgress': 'పురోగతిలో',
    'cl.completed': 'పూర్తయింది',

    reminders: 'రిమైండర్లు',
    reminderDate: 'రిమైండర్ తేదీ',
    noReminders: '🔔 రాబోయే రిమైండర్లు లేవు!',
    overdueReminders: 'ఆలస్యమైనవి',
    upcomingReminders: 'రాబోయేవి',
    dueToday: 'ఈరోజు',
  ...
  ta: {
    ...
    'cf.measurements': 'அளவுகள்',
    'cf.fabricType': 'துணி வகை',
    'cf.designNotes': 'வடிவமைப்பு குறிப்புகள்',
    'cf.grainType': 'தானிய வகை',
    'cf.quantity': 'அளவு',
    'cf.millingType': 'அரைக்கும் வகை',
    'cf.clayType': 'களிமண் வகை',
    'cf.size': 'அளவு',
    'cf.brand': 'பிராண்ட்',
    'cf.deviceType': 'சாதன வகை',
    'cf.problemDesc': 'பிரச்சனை விவரம்',
    'cf.serialNumber': 'சீரியல் எண்',
    'cf.classGrade': 'வகுப்பு / தரம்',
    'cf.batchTime': 'பேட்ச் நேரம்',
    'cf.parentName': 'பெற்றோர் பெயர்',
    'cf.deliveryAddress': 'டெலிவரி முகவரி',
    'cf.notes': 'குறிப்புகள்',

    'cl.cutFabric': 'துணி வெட்டுதல்',
    'cl.stitch': 'தையல்',
    'cl.buttons': 'பட்டன்கள் & ஃபினிஷிங்',
    'cl.iron': 'இஸ்திரி',
    'cl.qualityCheck': 'தரச் சோதனை',
    'cl.grainReceived': 'தானியம் பெறப்பட்டது',
    'cl.cleaning': 'சுத்தம் செய்தல்',
    'cl.milling': 'அரைத்தல்',
    'cl.packing': 'பேக்கிங்',
    'cl.readyPickup': 'பிக்கப்புக்கு தயார்',
    'cl.shaping': 'வடிவமைத்தல்',
    'cl.drying': 'உலர்த்துதல்',
    'cl.firing': 'சுடுதல்',
    'cl.painting': 'வண்ணம் தீட்டுதல்',
    'cl.readyDelivery': 'டெலிவரிக்கு தயார்',
    'cl.itemPicked': 'பொருள் எடுக்கப்பட்டது',
    'cl.packed': 'பேக் செய்யப்பட்டது',
    'cl.delivered': 'டெலிவரி ஆனது',
    'cl.diagnosed': 'பரிசோதிக்கப்பட்டது',
    'cl.partsOrdered': 'உதிரிபாகங்கள் ஆர்டர் செய்யப்பட்டன',
    'cl.repairDone': 'பழுது பார்க்கப்பட்டது',
    'cl.testing': 'சோதனை',
    'cl.enrolled': 'சேர்க்கை',
    'cl.booksGiven': 'புத்தகங்கள் கொடுக்கப்பட்டன',
    'cl.firstSession': 'முதல் அமர்வு முடிந்தது',
    'cl.feeCollected': 'கட்டணம் பெறப்பட்டது',
    'cl.loaded': 'ஏற்றப்பட்டது',
    'cl.dispatched': 'அனுப்பப்பட்டது',
    'cl.received': 'பெறப்பட்டது',
    'cl.inProgress': 'நடைபெறுகிறது',
    'cl.completed': 'நிறைவடைந்தது',

    reminders: 'நினைவூட்டல்கள்',
    reminderDate: 'நினைவூட்டல் தேதி',
    noReminders: '🔔 வரவிருக்கும் நினைவூட்டல்கள் இல்லை!',
    overdueReminders: 'தாமதமானவை',
    upcomingReminders: 'வரவிருப்பவை',
    dueToday: 'இன்று',
    checklist: 'செக்லிஸ்ட்',
